		...
		<div id="main_contents">
			<div id="contents">
				<div class="search_form">
					<h3>User Search</h3>
					<form:form action="/SpringMVC-MyBatis-StudentManagement/searchUser/" method="get" modelAttribute="sBean">
						...
						<br /> <input type="submit" value="Search" class="button"
							onclick="searchList()" /> <a href="/SpringMVC-MyBatis-StudentManagement/setupAddUser/"> <input
							type="button" value="Add" class="button" id="userInsert" />
						</a> <input type="button" value="Reset" class="button"
							onclick="location.href='/SpringMVC-MyBatis-StudentManagement/setupUser/'" />
					</form:form>
					<br /> <br />
					<div id="errormsg">
				...
				<div id="list">
					<table class="resultTable">
						...
						<c:forEach items="${userList}" var="data">
							<tr>
								<td><a href="/SpringMVC-MyBatis-StudentManagement/deleteUser/${data.id}"><input type="button" value="Delete" id="deleteuser" class="button"
											onclick="javascript:checkDelete()" /></a>
									</td>
								<td><a href="/SpringMVC-MyBatis-StudentManagement/setupUpdateUser/${data.id}"> <input
