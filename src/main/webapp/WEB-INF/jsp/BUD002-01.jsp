...
<script type="text/javascript">
	function deleteBudget() {
		...
		if (isOk) {
			window.location.replace('/SpringMVC-MyBatis-StudentManagement/studentsearch/')
		}
	}
...
<body class="main_body">
	...
	<div id="container">
		...
		<form:form action="/SpringMVC-MyBatis-StudentManagement/studentUpdate/"
					...
					<div class="search_form">
						...
						<div id="btnGroup">
							<input type="submit" value="Update" class="button"
								onclick="javascript:update()" /> <a href="/SpringMVC-MyBatis-StudentManagement/studentDelete/${upRemain.id}"><input type="button"
								value="Delete" id="delete" class="button"
								onclick="javascript:deleteBudget()" /></a> <input type="button"
								value="Back" class="button"
								onclick="window.location.replace('/SpringMVC-MyBatis-StudentManagement/setupStudentSearch/')" />
						</div>
					</div>
				</div>
			</div>
